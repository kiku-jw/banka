...
const livePlayFollowUp = [
  ...
  },
  {
    ...
    replacement: "Представь: решение выгодно тебе, но создаст неудобства другим. Как поступишь?",
  },
  {
    id: "spark-service-5",
    rejected: "Был ли в служении момент, когда забота Иеговы ощущалась особенно явно? Если да, расскажи.",
    replacement: "В какой части служения тебе чаще всего приходится преодолевать себя?",
  },
  {
    id: "spark-service-20",
  ...
  },
  {
    ...
    replacement: "Если планы в служении неожиданно меняются, как ты обычно перестраиваешься?",
  },
  {
    id: "spark-bible-4",
  ...
  },
  {
    ...
    replacement: "По чему ты понимаешь, что разговор о Библии лучше закончить?",
  },
  {
    id: "closer-service-9",
    rejected: "Был ли неожиданный ответ в служении, над которым хотелось потом подумать? Какой?",
    replacement: "Что ты говоришь в служении, когда не знаешь ответа на вопрос?",
  },
  {
    id: "closer-bible-3",
  ...
  },
  {
    ...
    replacement: "Позови кого-нибудь и обсудите: где для вас проходит граница между настойчивостью и давлением в служении?",
  },
  {
    ...
    replacement: "Выбери кого-нибудь и спроси: «Что в служении тебе труднее всего принимать спокойно?»",
  },
  {
    ...
    replacement: "Позови кого-нибудь и обсудите: как вы решаете, чем можно пожертвовать ради духовной цели, а чем пока нет?",
  },
  {
    id: "together-bible-5",

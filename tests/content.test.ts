...
const livePlayFollowUp = [
  ...
  },
  {
    ...
    replacement: "Друзья выбрали ресторан, который тебе не по карману. Скажешь об этом прямо, предложишь другое место или пойдёшь и сэкономишь на чём-то другом?",
  },
  {
    id: "spark-service-5",
    rejected: "Был ли в служении момент, когда забота Иеговы ощущалась особенно явно? Если да, расскажи.",
    replacement: "Представь, что пробуешь незнакомый вид служения. Что выберешь: начать разговор, попросить напарника начать или сначала понаблюдать?",
  },
  {
    id: "spark-service-20",
  ...
  },
  {
    ...
    replacement: "Напарник в последний момент полностью меняет план. Ты подстроишься, будешь отстаивать прежний или предложишь третий вариант?",
  },
  {
    id: "spark-bible-4",
  ...
  },
  {
    ...
    replacement: "После серьёзной ссоры по чему ты понимаешь, что человеку снова можно доверять?",
  },
  {
    id: "closer-service-5",
    rejected: "Если доводилось участвовать в разных видах служения, какой оказался самым непривычным?",
    replacement: "Собеседник говорит: «Мне пора», но тут же задаёт интересный вопрос. Ответишь коротко, предложишь продолжить потом или сразу попрощаешься?",
  },
  {
    id: "closer-service-9",
  ...
  },
  {
    ...
    replacement: "Позови кого-нибудь: один говорит «Мне неинтересно», но продолжает задавать вопросы. Другой решает, продолжать разговор или попрощаться. Потом поменяйтесь ролями.",
  },
  {
    ...
    replacement: "Выбери кого-нибудь и угадай: после резкого отказа этот человек быстро переключится, пошутит или ещё долго будет вспоминать разговор? Потом проверь.",
  },
  {
    ...
    replacement: "Позови кого-нибудь и одновременно назовите, чем вам легче пожертвовать ради важной духовной цели: деньгами, комфортом или свободным временем. Совпали ответы?",
  },
  {
    id: "together-bible-5",
